  ...
  const NAV_CATEGORIES_NATIONAL: NavCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "#/evaluations-politiques",       label: "Évaluations politiques",    target: "evaluations-politiques",         description: "15 grandes politiques évaluées par Cour des comptes / IPP / France Stratégie" },
        { href: "#/comparaisons-internationales", label: "Comparaisons UE/OCDE",      target: "comparaisons-internationales",   description: "France vs 10 pays sur 15 indicateurs (dette, fiscalité, dépenses, société)" },
      ],
    },
    {
